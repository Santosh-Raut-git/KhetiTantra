...
export default function SignupScreen() {
  ...
  async function signUpWithEmail() {
    ...
    // PRD FR-A1: minimum eight-character password
      ...
      >
        <ScrollView contentContainerClassName="flex-grow justify-center px-6 py-12 md:max-w-md md:w-full md:self-center">
          ...
          <View className="flex-row justify-center mt-6">
            <Text className="text-soil-muted" style={{ fontFamily: 'Inter-Regular' }}>Already have an account? </Text>
            <Link href="/(auth)/login" asChild>
              <Text className="text-leaf font-bold" style={{ fontFamily: 'Inter-Bold' }}>Log In</Text>
            </Link>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
