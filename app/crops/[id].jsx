    ...
    <SafeAreaView className="flex-1 bg-sand" edges={['top']}>
      ...
      >
        <Card className="mb-6 items-center pt-8 pb-8">
          ...
          <Text
            className="text-soil text-3xl font-bold mb-1"
            style={{ fontFamily: 'Inter-Bold' }}
          >
            {crop.crop_name}
          </Text>
          ...
          <View className="bg-surface border border-soil/10 px-4 py-1.5 rounded-full">
            <Text
              className={`font-bold capitalize ${getStatusColor(crop.status)}`}
              style={{ fontFamily: 'Inter-Bold' }}
            >
              {crop.status}
            </Text>
          ...
          {crop.status === 'harvested' && (
            <>
              <View className="flex-row justify-between py-3 border-b border-soil/5">
                ...
                <Text
                  className="text-soil font-semibold text-leaf"
                  style={{ fontFamily: 'Inter-Medium' }}
                >
              ...
              <View className="flex-row justify-between py-3">
                ...
                >
                  {crop.yield_quantity
                    ? `${crop.yield_quantity} ${crop.yield_unit}`
                    : '-'}
                </Text>
              </View>
            </>
        ...
        <Card className="mb-8 bg-leaf/5 border-leaf/20">
          ...
          <View className="flex-row justify-between py-4">
            <Text
              className="text-soil font-bold text-lg"
              style={{ fontFamily: 'Inter-Bold' }}
            >
              Net Profit
            </Text>
