  ...
  return (
    <SafeAreaView className="flex-1 bg-sand" edges={['top']}>
      ...
      <ScrollView
        ...
        contentContainerClassName="p-5 pb-12 md:max-w-2xl md:w-full md:self-center md:py-8"
      >
        <Card className="mb-6 items-center pt-8 pb-8">
          <View
            className={`w-20 h-20 rounded-full items-center justify-center mb-4 ${tx.type === 'income' ? 'bg-leaf/10' : 'bg-clay/10'}`}
          >
            <Receipt
              size={40}
          ...
          <Text
            className="text-soil-muted text-base mb-3"
          ...
          <View className="bg-surface border border-soil/10 px-4 py-1.5 rounded-full">
            <Text
              className="font-bold text-soil capitalize"
              style={{ fontFamily: 'Inter-Bold' }}
            >
              {tx.category}
            </Text>
        ...
        <Text
          className="text-soil text-lg font-bold mb-3 px-1"
          style={{ fontFamily: 'Inter-Bold' }}
        >
          Details
        </Text>
        <Card className="mb-6">
          <View className="flex-row justify-between py-3 border-b border-soil/5">
            ...
            <Text
              className="text-soil font-semibold"
              style={{ fontFamily: 'Inter-Medium' }}
            >
              {tx.crops?.crop_name}
            </Text>
        ...
        {tx.receipt_url && (
          <>
            <Text
              className="text-soil text-lg font-bold mb-3 px-1 mt-2"
              style={{ fontFamily: 'Inter-Bold' }}
            >
              Receipt
            </Text>
