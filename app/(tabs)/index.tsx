...
import { Sprout, TrendingUp, TrendingDown, Plus, Wallet, FileText, ArrowRight } from 'lucide-react-native';
...
// ---------------------------------------------------------------------------
// QuickActionCard — animated wrapper for each quick-action row
// ---------------------------------------------------------------------------
...
function QuickActionCard({ onPress, children }: QuickActionCardProps) {
...
export default function DashboardScreen() {
  ...
  const { data: crops, isLoading: cropsLoading, refetch: refetchCrops } = useCrops();
  ...
  return (
    <SafeAreaView className="flex-1 bg-sand" edges={['top']}>
      ...
      >
        ...
        <Animated.View entering={FadeInUp.delay(120).duration(450)}>
          ...
          <View className="flex-row gap-4 mb-4">
            <Card className="flex-1">
              ...
              <Text className="text-soil-muted text-sm mb-1" style={{ fontFamily: 'Inter-Medium' }}>Net Balance</Text>
              <Text
                className="text-xl font-bold"
                style={{ fontFamily: 'Inter-Bold', color: netProfit >= 0 ? '#2E7D32' : '#D32F2F' }}
              >
        ...
        <Animated.View entering={FadeInUp.delay(200).duration(450)} className="flex-row gap-4 mb-8">
          <Card className="flex-1">
            <View className="flex-row items-center mb-2">
              <View className="w-6 h-6 rounded-full bg-leaf/10 items-center justify-center mr-2">
                <TrendingUp size={14} color="#2E7D32" />
              </View>
              <Text className="text-soil-muted text-sm" style={{ fontFamily: 'Inter-Medium' }}>Income</Text>
            </View>
            <Text className="text-leaf text-lg font-bold" style={{ fontFamily: 'Inter-Bold' }}>
          ...
          <Card className="flex-1">
            <View className="flex-row items-center mb-2">
              ...
              <Text className="text-soil-muted text-sm" style={{ fontFamily: 'Inter-Medium' }}>Expense</Text>
            </View>
            <Text className="text-clay text-lg font-bold" style={{ fontFamily: 'Inter-Bold' }}>
          ...
          <Animated.View entering={FadeInUp.delay(340).duration(450)}>
            <QuickActionCard onPress={() => router.push('/crops/new')}>
              <View className="flex-row items-center">
                ...
                <View>
                  <Text className="text-soil text-base font-bold" style={{ fontFamily: 'Inter-Bold' }}>Add Crop</Text>
                  <Text className="text-soil-muted text-sm" style={{ fontFamily: 'Inter-Regular' }}>Start a new crop cycle</Text>
                </View>
              </View>
          ...
          <Animated.View entering={FadeInUp.delay(400).duration(450)}>
            <QuickActionCard onPress={() => router.push('/ledger/new')}>
              <View className="flex-row items-center">
                ...
                <View>
                  <Text className="text-soil text-base font-bold" style={{ fontFamily: 'Inter-Bold' }}>Add Transaction</Text>
                  <Text className="text-soil-muted text-sm" style={{ fontFamily: 'Inter-Regular' }}>Record income or expense</Text>
                </View>
              </View>
              <ArrowRight size={20} color="#BDB8B0" />
            </QuickActionCard>
