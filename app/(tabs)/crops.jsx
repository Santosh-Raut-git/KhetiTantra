...
import { useCrops, useCropProfits } from '@/lib/api/crops';
...
function CropCard({ crop, index, netProfit, onPress }) {
      ...
      >
        ...
        <View className="flex-1">
          ...
          <View className="flex-row items-center gap-2 mt-1">
            ...
            <Text
              className={`text-xs capitalize font-medium ${getStatusColor(crop.status)}`}
        ...
        <View className="items-end mr-2">
          <Text
            className="text-soil-muted text-xs mb-1"
            style={{ fontFamily: 'Inter-Regular' }}
          >
            Net Profit
          </Text>
  ...
  return (
    <SafeAreaView className="flex-1 bg-sand" edges={['top']}>
      ...
      <ScrollView
        ...
        contentContainerClassName="px-5 pb-8 pt-4 md:max-w-3xl md:w-full md:self-center md:py-8"
      >
        {crops?.length === 0 ? (
          <EmptyState
