...
interface ImagePickerProps {
  label?: string;
  value?: string; // public URL or local URI
...
export function AppImagePicker({ label, value, onImageSelected, onImageRemoved, error, isUploading }: ImagePickerProps) {
  ...
  return (
    <View className="mb-4">
      ...
      {value ? (
        ...
        <View className={`w-full h-32 rounded-xl border-2 border-dashed ${error ? 'border-clay bg-clay/5' : 'border-soil/15 bg-surface'} items-center justify-center flex-row gap-4`}>
          {loading ? (
            ...
            <>
              ...
              >
                ...
                <Text className="text-soil-muted text-xs" style={{ fontFamily: 'Inter-Medium' }}>Gallery</Text>
              </Pressable>
              ...
              >
                ...
                <Text className="text-soil-muted text-xs" style={{ fontFamily: 'Inter-Medium' }}>Camera</Text>
              </Pressable>
            </>
          )}
        </View>
